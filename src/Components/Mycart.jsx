...
function Mycart() {
  ...
  return (
    <div className="p-4">
      <h1 className="text-4xl font-bold mb-2 flex gap-2 "><FaShoppingCart className='text-5xl min-w-[1.25rem]'/> My Cart</h1>
      <div className="space-y-4">
        {cartItems.length > 0 ? (
          cartItems.map((item) => (
            <div key={item.key} className="flex justify-between items-center p-4 bg-white shadow-md rounded-lg">
